...
class ECKEditor extends CInputWidget {
    ...
    public function  __construct($owner=null) {
		...
		$_SESSION['KCFINDER']['uploadURL'] = $_SERVER['DOCUMENT_ROOT']."/images/work/"; // URL for the uploads folder
		$_SESSION['KCFINDER']['uploadDir'] = $_SERVER['DOCUMENT_ROOT']."/images/work/"; // path to the uploads folder
